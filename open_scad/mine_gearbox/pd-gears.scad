// Downloaded from: https://github.com/sadr0b0t/pd-gears
//
//////////////////////////////////////////////////////////////////////////////////////////////
...
module inner_gear (
	...
	r  = p-(p-b)/3;                                //radius of root circle
	t  = mm_per_tooth/2+backlash/2;                //tooth thickness at pitch circle
	k  = -iang(b, p) - t/2/p/PI*180; {             //angle to where involute meets base circle on each side of tooth
		difference() {
			cylinder(h=thickness*0.99 , r=outer_diameter/2, center=center, $fn=60);
			for (i = [0:number_of_teeth-teeth_to_hide-1] )
				rotate([0,0,i*360/number_of_teeth])
					linear_extrude(height = thickness*1.01, center = center, convexity = 10, twist = twist)
						polygon(
							points=[
								[0, -1/10],
