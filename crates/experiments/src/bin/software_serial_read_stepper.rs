...
mod app {
    ...
    struct Local {
        ...
        tmc2209_msg_sender_1: Tmc2209RequestProducer,
        tmc2209_msg_sender_2: Tmc2209RequestProducer,
    ...
    fn init(cx: init::Context) -> (Shared, Local) {
        ...
        (
            ...
            Local {
                ...
                tmc2209_msg_sender_1: tmc2209_0.req_sender.clone(),
                tmc2209_msg_sender_2: tmc2209_0.req_sender,
    ...
    //INFO: I used this code to test communication with tmc2209. Now it is tested and works fine.
    //So I moved 'tmc2209_rsp_receiver' inside Configurator, it is not clonable, so cant move it
    //here.
    //
